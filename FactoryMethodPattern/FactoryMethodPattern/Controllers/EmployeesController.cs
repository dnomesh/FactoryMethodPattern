...
using FactoryMethodPattern.Factory.FactoryMethod;
...
namespace FactoryMethodPattern.Controllers
{
    ...
    {
        private FactoryMethodDBEntities db = new FactoryMethodDBEntities();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,JobDescription,Number,Department,HourlyPay,Bonus,EmployeeType,HouseAllowance,MedicalAllowance")] Employee employee)
        {
            if (ModelState.IsValid)
            {
